...
function createMacroXml(preset, timecodeName) {
    const context = {
        timecodeName,
    };
    const obj = {
...
function createPreset(id, groupId, label, xmlName, lines) {
    return {
        id,
        groupId,
        label,
...
export const exampleMacroPresetGroups = [
    {
        id: "show-time",
        label: "Show time",
    ...
    },
    {
        ...
        presets: [
            ...
            createPreset("timecode-rewind-and-switch-int", "timecode-control", "timecode rewind and switch int", "Timecode Rewind and Switch INT", [
            ...
            createPreset("timecode-rewind-tc-and-switch-ltc", "timecode-control", "timecode rewind tc and switch ltc", "Timecode Rewind TC and Switch LTC", [
...
export function resolveExampleMacroTimecodeName(timecodeName, sourceFileName) {
...
export function createExampleMacroPresetOutputFiles(options) {
    ...
    return exampleMacroPresetGroups.flatMap((group) => group.presets
...
//# sourceMappingURL=macro-presets.js.map