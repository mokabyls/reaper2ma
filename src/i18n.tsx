...
const messages = {
    ...
    "sequences.repeatPrefixToggle": { fr: "Ajouter un identifiant aux répétitions et bumps", en: "Add an identifier to repeats and bumps" },
    "sequences.repeatPrefixToggleHelp": { fr: "Optionnel. Désactivé, « Drop » devient par exemple « MA Drop ». Activé avec « FX », il devient « MA FX - Drop ». Cela ne change ni le timing ni le numéro des séquences.", en: "Optional. When disabled, “Drop” becomes “MA Drop”, for example. Enabled with “FX”, it becomes “MA FX - Drop”. This changes neither timing nor sequence numbers." },
    "sequences.repeatPrefix": { fr: "Identifiant personnalisé", en: "Custom identifier" },
    "sequences.repeatPrefixHelp": { fr: "Texte court inséré uniquement dans les noms des séquences colorées et des bumps. Utilisez par exemple FX, Vidéo ou Acte 1.", en: "Short text inserted only into colored-sequence and bump names. For example: FX, Video, or Act 1." },
    ...
    "output.timecodeOffset": { fr: "Offset du timecode entrant", en: "Incoming timecode offset" },
    "output.timecodeOffsetHelp": { fr: "Décale nativement l’objet Timecode grandMA3 par rapport au LTC entrant, sans déplacer les événements du CSV. Utilise par exemple +01:00:00.000 pour conserver un projet REAPER démarrant à zéro avec un LTC démarrant à une heure.", en: "Natively offsets the grandMA3 Timecode object from incoming LTC without moving CSV events. For example, use +01:00:00.000 to keep a REAPER project starting at zero while LTC starts at one hour." },
    "output.timecodeOffsetInvalid": { fr: "Saisissez HH:MM:SS ou HH:MM:SS.mmm, avec un signe facultatif, entre -255:59:58.960 et +255:59:58.960.", en: "Enter HH:MM:SS or HH:MM:SS.mmm, optionally signed, between -255:59:58.960 and +255:59:58.960." },
    "output.timecodeOffsetExampleStart": { fr: "Un événement placé à", en: "An event placed at" },
    "output.timecodeOffsetExampleMiddle": { fr: "sera déclenché lorsque le LTC entrant atteindra", en: "will trigger when incoming LTC reaches" },
    "output.timecodeOffsetNegativeWarning": { fr: "Cet offset place au moins un événement avant zéro. L’export reste possible, mais ce ou ces événements ne pourront pas être atteints par un LTC positif.", en: "This offset places at least one event before zero. Export remains available, but those events cannot be reached by positive LTC." },
    ...
    "summary.notApplied": { fr: "Non appliqué", en: "Not applied" },
    ...
    "timeline.timecodeOffset": { fr: "Offset Timecode", en: "Timecode offset" },
    "timeline.relativeTime": { fr: "Temps relatif", en: "Relative time" },
    "timeline.effectiveLtc": { fr: "LTC entrant effectif", en: "Effective incoming LTC" },
